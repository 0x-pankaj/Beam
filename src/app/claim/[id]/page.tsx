  ...
  if (notFound)
    return (
      <main className="beam-shell items-center justify-center text-center">
        <p className="text-lg text-[var(--muted)]">This link doesn&apos;t exist.</p>
      </main>
    );
  ...
  if (link.status === "paid") {
    return (
      <main className="beam-shell items-center justify-center text-center">
        ...
        <h1 className="text-3xl font-black">{usd(link.amountUsd)} received</h1>
        <p className="text-[var(--muted)]">Settled on Arbitrum — it&apos;s yours.</p>
        {link.txId && (
          <a
